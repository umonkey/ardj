...
################################
    ...
    def send_tune(self, song, debug=False):
        """
        Sets information about the currently played tune. Song is a dictionary
        with keys: file, title, artist, album, pos, track, length, uri. For
        details see <http://xmpp.org/protocols/tune/>.
        """
