...
class database:
	...
	def __init__(self, filename):
		...
		cur = self.db.cursor()
		cur.execute('CREATE TABLE IF NOT EXISTS playlists (id INTEGER PRIMARY KEY, priority REAL, name TEXT, repeat INTEGER, delay INTEGER, hours TEXT, days TEXT, last_played INTEGER, labels TEXT)')
